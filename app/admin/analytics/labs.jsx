            ...
            <table>
              ...
              ${orders
                .map((o) => {
                  ...
                  <tr>
                    <td>${d}</td>
                    <td>${o.collectionAddress?.fullName}</td>
                    <td>${o.collectionAddress?.phone}</td>
                    <td>${o.orderStatus}</td>
    ...
    <SafeAreaView style={styles.safe} edges={["bottom"]}>
      ...
      {loading && !refreshing ? (
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={styles.center}>
              <Text style={styles.emptyTxt}>No bookings found for this period.</Text>
            </View>
          }
          renderItem={({ item }) => {
            ...
            return (
              <View style={styles.card}>
                <View style={styles.row}>
                  <Text style={styles.docName}>{item.collectionAddress?.fullName || "Unknown"}</Text>
