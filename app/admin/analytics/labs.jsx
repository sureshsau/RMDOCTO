...
export default function LabsList() {
  ...
  const fetchOrders = useCallback(async (isRefresh = false) => {
    try {
      ...
      const res = await api.get("/lab/order/view/all", { params });
          ...
          <body>
            ...
            <div style="text-align: center;">
              <div class="summary-box">
                ...
                <p><strong>Total Bookings Processed:</strong> ${orders.length}</p>
              </div>
            </div>

            <table>
              <tr>
                <th>Date & Booking ID</th>
              ...
              ${orders
                .map((o) => {
                  ...
                  const addr = o.collectionAddress || {};
  ...
  const getStatusColor = (status) => {
    switch (status?.toLowerCase()) {
      case "completed": 
      case "results_delivered": return "#10b981";
    ...
    <SafeAreaView style={styles.safe} edges={["bottom"]}>
      ...
      {loading && !refreshing ? (
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={styles.center}>
              <Ionicons name="flask-outline" size={64} color="#cbd5e1" style={{ marginBottom: 16 }} />
              <Text style={styles.emptyTxt}>No lab bookings found for this period.</Text>
            </View>
          }
          renderItem={({ item }) => {
            const d = new Date(item.createdAt);
            const statusColor = getStatusColor(item.orderStatus);
            const addr = item.collectionAddress || {};
            const addressString = [addr.addressLine1, addr.addressLine2, addr.city, addr.state, addr.pincode].filter(Boolean).join(", ");
              ...
              <View style={styles.card}>
                ...
                <View style={styles.detailsGrid}>
                  ...
                  <View style={styles.detailRow}>
                    ...
                    <View>
                      <Text style={styles.detailLabel}>Booking Revenue</Text>
