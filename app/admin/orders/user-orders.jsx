...
const styles = StyleSheet.create({
  ...
  rangePills: { flexDirection: "row", paddingHorizontal: 16, paddingTop: 12, paddingBottom: 8, gap: 8 },
  rangePill: {
    flexShrink: 0, paddingHorizontal: 18, paddingVertical: 8,
  ...
  summaryGrid: { flexDirection: "row", flexWrap: "wrap", gap: 10, marginBottom: 16, marginTop: 8 },
  summaryChip: {
